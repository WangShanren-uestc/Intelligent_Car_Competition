...
//      模块通道    端口          可选范围                                    建议
#define UART0_RX_PIN    PTB16       //PTA1、PTA15、PTB16、PTD6、PTE21
#define UART0_TX_PIN    PTB17       //PTA2、PTA14、PTB17、PTD7、PTE20
...
//      模块通道    端口          可选范围                                    建议
#define I2C0_SCL_PIN    PTB2        // PTB0、PTB2、PTC8、PTE19、PTE24
#define I2C0_SDA_PIN    PTB1        // PTB1、PTB3、PTC9、PTE18、PTE25
