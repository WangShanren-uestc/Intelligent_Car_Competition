...
//  OutData[0]=g_fGravityAngle;//Red 
//  OutData[1]=g_fGyroscopeAngleSpeed; 
  OutData[1]=g_fGravityAngle; //Yellow
}
...
void AngleControl(void) { 
  ...
  g_fAngleControlOut = fValue;
   ...
   OutData[2]=g_fCarAngle;//blue
//   OutData[3]=g_fGyroscopeAngleSpeed;//pink
} 
...
//  OutData[0]=fLeftVoltage * 256;
//  OutData[1]=fRightVoltage ;
...
void SpeedControl(void) {
  ...
  DIR_CONTROL_P =  0.11*g_fCarSpeed;
  ...
  if(g_fSpeedControlIntegral>30)g_fSpeedControlIntegral=30;
  else if(g_fSpeedControlIntegral<-30)g_fSpeedControlIntegral=-30;
...
//  OutData[2]=g_fSpeedControlIntegral;
  OutData[3]=g_fCarSpeed*100;
//  OutData[0]=CAR_SPEED_SETfDelta;
...
void DirectionControl(void) {
  ...
  OutData[0]=g_nLeftVoltageSigma*100;
  OutData[1]=g_nRightVoltageSigma*100;
...
//                        sendimgflag=-sendimgflag;
                      ...
                      case 'd':
                        sendimgflag++;
                        if(sendimgflag>2)sendimgflag=0;
                        break;   
                      case '-':
                        A_Ctrlflag=-1;
                        break; 
...
//        S_Ctrlflag = 1;
//        D_Ctrlflag = 1;
//        pit_init_ms(PIT0,3000);
//        break;
//      case 1:
//        if(mode==2){
//          CAR_SPEED_SETfDelta = REN_SPEED;
//        }
//        else{
//          CAR_SPEED_SETfDelta = Speed_set;
//        }
//        
